...
export const getPathName = (state: Object) =>
  state.routing.locationBeforeTransitions.pathname;

export const splitPathName = createSelector([getPathName], (pathName: string) =>
  pathName.split('/')
);
...
export const parameterizeURL = createSelector(
  [splitPathName],
  (pathName: string[]) =>
    pathName.reduce((ids, partialPath) => {
...
export const getIdParam = (i: number) =>
  createSelector([parameterizeURL], ids => ids[i]);
...
export const getQuery = (suffix?: string = '') =>
  createSelector(
