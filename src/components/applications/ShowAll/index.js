...
const getApplicationIds = pageApplicationSelectors.getRelatedIds(
  'applications'
);
...
const getProjectIds = createSelector(
  [getInternshipIds, internshipSelectors.findMonoRelationshipData('project')],
...
const onInternshipIdsChange = props => {
  return props.indexInternships(props.internshipIds).then(internships => {
...
export default flowRight([
  ...
  khange([[kheck('internshipIds'), onInternshipIdsChange]]),
])(ApplicationsIndex);
