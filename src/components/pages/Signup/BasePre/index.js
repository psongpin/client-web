...
export default class PreBase extends PureComponent {
  ...
  render() {
    return (
      <PanelContent title={this.props.title}>
        {this.props.termsOfService && (
          <TermsOfService
            isOpen={this.state.termsOfService}
            onClose={this.closeTermsOfService}
            iAgree={this.iAgree}
          />
        )}
        {this.props.termsOfService && (
          <div className={termsOfService}>
            <p>
              ...
              <Clickable onClick={this.openTermsOfService}>
                TERMS OF SERVICES
              </Clickable>{' '}
              before signing up
            </p>
        ...
        <div className={nav}>
          <Navigation type="vertical">
            <LinkedIn
              disabled={!this.state.iAgree && this.props.termsOfService}
            />
            {process.env.NODE_ENV !== 'production' && (
              <Button className={button} onClick={this.props.emailAction}>
                Email
              </Button>
            )}
          </Navigation>
